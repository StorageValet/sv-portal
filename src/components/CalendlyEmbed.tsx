...
export default function CalendlyEmbed({ url = DEFAULT_CALENDLY_URL, onClose }: CalendlyEmbedProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-sv-cream rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col mx-4">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-sv-sand">
          <h2 className="text-lg font-semibold text-sv-midnight">Book an Appointment</h2>
          {onClose && (
            <button
              onClick={onClose}
        ...
        <div className="flex-1 relative min-h-[600px]">
          {isLoading && (
            <div className="absolute inset-0 flex items-center justify-center bg-sv-cream z-10">
              <div className="text-center">
                ...
                <p className="text-sv-slate/70">Loading scheduler...</p>
              </div>
            </div>
          )}
          <InlineWidget
