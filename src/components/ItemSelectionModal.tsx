...
export default function ItemSelectionModal({ actionId }: ItemSelectionModalProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-sv-bone border border-sv-sand rounded-lg p-4 mb-6">
        <div className="flex items-start">
          <svg className="h-5 w-5 text-sv-navy mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <div className="text-sm text-sv-slate">
            <p className="font-medium mb-1">How Item Selection Works</p>
            <ul className="list-disc list-inside space-y-1 text-sv-slate">
